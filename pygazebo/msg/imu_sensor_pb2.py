...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[sensor_noise_pb2.DESCRIPTOR,])
...
_IMUSENSOR_ANGULARVELOCITY.fields_by_name['x_noise'].message_type = sensor_noise_pb2._SENSORNOISE
_IMUSENSOR_ANGULARVELOCITY.fields_by_name['y_noise'].message_type = sensor_noise_pb2._SENSORNOISE
_IMUSENSOR_ANGULARVELOCITY.fields_by_name['z_noise'].message_type = sensor_noise_pb2._SENSORNOISE
_IMUSENSOR_ANGULARVELOCITY.containing_type = _IMUSENSOR
_IMUSENSOR_LINEARACCELERATION.fields_by_name['x_noise'].message_type = sensor_noise_pb2._SENSORNOISE
_IMUSENSOR_LINEARACCELERATION.fields_by_name['y_noise'].message_type = sensor_noise_pb2._SENSORNOISE
_IMUSENSOR_LINEARACCELERATION.fields_by_name['z_noise'].message_type = sensor_noise_pb2._SENSORNOISE
